...
Code repositories are an important technology in IT. They allow several things:
...
up the load. Theoretically, the whole distributed system _could_ come down, but its highly
unlikely
